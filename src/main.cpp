...
#define initAng1 280.22
#define initAng2 43.68
#define mPrecision 0.2
#define mSpeed 6000

#define REDUCION_RATIO 200*8/(2*3.1415926535)
...
void track(float angD1, float angD2, float angD3) {
  // Reverse deriction of third axis
  angD3 = -angD3;
  if (angD3 != 0.0) {
    for (int i = 0; i < abs(angD3)*REDUCION_RATIO; i++) motorStep(sign(angD3), 3, 50);
  } else {
